...
export type CrashCourseIntro = import('./crash-course-intro').CrashCourseIntro;
export type CrashCoursePart = import('./crash-course-part').CrashCoursePart;
...
declare global {
  namespace XP {
    interface ContentTypes {
      ...
      'idebanken:crash-course-intro': CrashCourseIntro;
      'idebanken:crash-course-part': CrashCoursePart;
