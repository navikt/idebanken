...
export type XP_CrashCourseIntro = import('./crash-course-intro').XP_CrashCourseIntro;
export type XP_CrashCoursePart = import('./crash-course-part').XP_CrashCoursePart;
...
declare global {
  namespace XP {
    interface ContentTypes {
      ...
      'idebanken:crash-course-intro': XP_CrashCourseIntro;
      'idebanken:crash-course-part': XP_CrashCoursePart;
