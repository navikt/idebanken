...
abstract class AbstractIntegrationTest {
    ...
    private fun UriComponentsBuilder.queryParamIfPresent(
        name: String,
        value: Any?,
    ): UriComponentsBuilder {
        when (value) {
    ...
    protected final inline fun <reified T : Any> get(uri: String): ResponseEntity<T> = restTemplate.getForEntity<T>(uri)
